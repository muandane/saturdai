...
func (in *BinPackingHints) DeepCopyInto(out *BinPackingHints) {
	*out = *in
	...
	if in.SchedulerBalanceScore != nil {
		in, out := &in.SchedulerBalanceScore, &out.SchedulerBalanceScore
		*out = new(float64)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterChildReference) DeepCopyInto(out *ClusterChildReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterChildReference.
func (in *ClusterChildReference) DeepCopy() *ClusterChildReference {
	if in == nil {
		return nil
	}
	out := new(ClusterChildReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterProfileStatus) DeepCopyInto(out *ClusterProfileStatus) {
	*out = *in
	if in.Children != nil {
		...
		*out = make([]ClusterChildReference, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceProfile) DeepCopyInto(out *NamespaceProfile) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceProfile.
func (in *NamespaceProfile) DeepCopy() *NamespaceProfile {
	if in == nil {
		return nil
	}
	out := new(NamespaceProfile)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NamespaceProfile) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceProfileList) DeepCopyInto(out *NamespaceProfileList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NamespaceProfile, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceProfileList.
func (in *NamespaceProfileList) DeepCopy() *NamespaceProfileList {
	if in == nil {
		return nil
	}
	out := new(NamespaceProfileList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NamespaceProfileList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceProfileSpec) DeepCopyInto(out *NamespaceProfileSpec) {
	*out = *in
	in.WorkloadSelector.DeepCopyInto(&out.WorkloadSelector)
	in.Policy.DeepCopyInto(&out.Policy)
	if in.MaxTargets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceProfileSpec.
func (in *NamespaceProfileSpec) DeepCopy() *NamespaceProfileSpec {
	if in == nil {
		return nil
	}
	out := new(NamespaceProfileSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceProfileStatus) DeepCopyInto(out *NamespaceProfileStatus) {
	*out = *in
	if in.Children != nil {
		in, out := &in.Children, &out.Children
		*out = make([]ChildReference, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceProfileStatus.
func (in *NamespaceProfileStatus) DeepCopy() *NamespaceProfileStatus {
	if in == nil {
		return nil
	}
	out := new(NamespaceProfileStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadKinds) DeepCopyInto(out *WorkloadKinds) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadKinds.
func (in *WorkloadKinds) DeepCopy() *WorkloadKinds {
	if in == nil {
		return nil
	}
	out := new(WorkloadKinds)
	in.DeepCopyInto(out)
	return out
}
